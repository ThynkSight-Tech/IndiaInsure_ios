...
class GTLTopUpVC: UIViewController {
    ...
    var siArray = ["25,00,000","50,00,000","75,00,000"]
    var premiumArray = ["11,208","19,276","21,162"]
    var criticalIllnessArray = ["10,00,000","20,00,000","20,00,000"]
        
        //["10 Lacs Critical Illness rider","20 Lacs Critical Illness rider","Rs.20 Lacs Critical Illness rider"]
...
//        self.view.backgroundColor = EnrollmentColor.ghiTop.value
    ...
    //getPolicyDataFromDatabase()
        ...
        private func getPolicyDataFromDatabase() {
            let policyData = DatabaseManager.sharedInstance.retrieveGroupBasicInfoDetails(productCode: "GTL")
...
//            self.timer = nil
    ...
    override func viewDidAppear(_ animated: Bool) {
       // tableView.reloadSections([0], with: UITableView.RowAnimation.bottom)
...
extension GTLTopUpVC:UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return 1 + GTLTopUpArray.count //GHI
...
//            return 130
    ...
    //MARK:- Currency Converter
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
                ...
                if indexPath.row == 0 {
                    ...
                    cell.lblHeaderName.text = "GTL Top-Up"
                    cell.lblDescription.text = "your employer provides you with \n the following GTL Top-up options"
                    cell.imgView.image = UIImage(named:"gtltopup")
                   ...
                   // cell.lblAmount.text = "₹ " + siArray[indexPath.row - 1]
                    ...
                    let amtText = GTLTopUpArray[indexPath.row - 1].sumInsured ?? ""
                    //cell.lblAmount.text =  getFormattedCurrency(amount: amtText)
                    cell.lblAmount.text =  "₹ "+amtText
                    let premiumAmtText = GTLTopUpArray[indexPath.row - 1].premiumAmount ?? ""
                    //cell.lblPremium.text = getFormattedCurrency(amount: premiumAmtText)
                       cell.lblPremium.text = "Premium ₹ "+premiumAmtText

                    
                    cell.lblRupee.isHidden = false

                    cell.lblCriticalIllness.text = criticalIllnessArray[indexPath.row - 1] + " Critical Illness rider"
                    
                       if !isDisabled{
                           if  GTLTopUpArray[indexPath.row - 1].isOpted == "YES" {
                               selectedGHIParentIndex = indexPath.row
                               // GTLTopUpArray[indexPath.row - 1].isOpted = "NO"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if GTLTopUpArray.count > 0{
            GTLTopUpArray[indexPath.row - 1 ].isOpted = "YES"
            print("Inside didSelectRowAt: ",GTLTopUpArray)
        }
    }
...
//MARK:- SERVER CALL
extension GTLTopUpVC {

    func OptTopUpToServer(parameter:NSDictionary,employeesrno:String,benefit_si:String,benefit_amount:String,mb_cust_prgs_bnft_sr_no:String,isAdd:Bool,setSummaryObj:summaryData,index:Int) {
                            ...
                            if let statusDict = data?["message"].dictionary
                            {
                                if let status = statusDict["Status"]?.bool {
                                    if status == true {
                                        ...
                                        selectedGTL = setSummaryObj
                                            self.selectedGHIParentIndex = index
...
//                                        self.displayActivityAlert(title: "Failed")
                                    }
                                }
                            }
...
extension GTLTopUpVC:UIScrollViewDelegate {
...
//             self.tableView.reloadData()
            ...
            let dict = ["employeesrno":empSrNo,"benefit_si":"0","benefit_amount":"0","benefit_amt_source":"1","mb_cust_prgs_bnft_sr_no":"6"]

            self.OptTopUpToServer(parameter: dict as NSDictionary, employeesrno: empSrNo, benefit_si: "0", benefit_amount: "0", mb_cust_prgs_bnft_sr_no: "6", isAdd: false, setSummaryObj: summaryData(), index: indexPath.row)
