...
class ClaimProcedureViewController: UIViewController,UITableViewDelegate,UITableViewDataSource, WKUIDelegate, WKNavigationDelegate {
...
//                cell.m_checklistLbl.text=htmlString?.htmlToString
        ...
        {
            cell.imageView?.image=UIImage(named: "Reimbursement_ios")
        }
