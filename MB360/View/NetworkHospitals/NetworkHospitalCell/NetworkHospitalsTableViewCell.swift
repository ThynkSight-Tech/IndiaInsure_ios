...
class NetworkHospitalsTableViewCell: UITableViewCell {
    ...
    func setupFontsUI(){
        //Header
        NumberOfHospitalHeaderLbl.font = UIFont(name: FontsConstant.shared.OpenSansSemiBold, size: CGFloat(FontsConstant.shared.h17))
        NumberOfHospitalHeaderLbl.textColor =  FontsConstant.shared.app_FontPrimaryColor
      
        
        m_totalCountLbl.font = UIFont(name: FontsConstant.shared.OpenSansSemiBold, size: CGFloat(FontsConstant.shared.h17))
        m_totalCountLbl.textColor =  FontsConstant.shared.app_FontBlackColor
      
        
        //Number count
        m_primaryCountButton.titleLabel?.font = UIFont(name: FontsConstant.shared.OpenSansSemiBold, size: CGFloat(FontsConstant.shared.h17))
        m_primaryCountButton.titleLabel?.textColor =  FontsConstant.shared.app_FontBlackColor
        
        m_secondaryCountButton.titleLabel?.font = UIFont(name: FontsConstant.shared.OpenSansSemiBold, size: CGFloat(FontsConstant.shared.h17))
        m_secondaryCountButton.titleLabel?.textColor =  FontsConstant.shared.app_FontBlackColor
        
        m_tertiaryCountButton.titleLabel?.font = UIFont(name: FontsConstant.shared.OpenSansSemiBold, size: CGFloat(FontsConstant.shared.h17))
        m_tertiaryCountButton.titleLabel?.textColor =  FontsConstant.shared.app_FontBlackColor
        
        m_OtherCountButton.titleLabel?.font = UIFont(name: FontsConstant.shared.OpenSansSemiBold, size: CGFloat(FontsConstant.shared.h17))
        ...
        m_nameLbl.font = UIFont(name: FontsConstant.shared.OpenSansSemiBold, size: CGFloat(FontsConstant.shared.h15))
        ...
        m_smsButton.titleLabel?.textColor = FontsConstant.shared.app_FontPincColor
        ...
        numberLbl.font = UIFont(name: FontsConstant.shared.OpenSansBold, size: CGFloat(FontsConstant.shared.h15))
        ...
        m_contactNumberButton.titleLabel?.textColor = FontsConstant.shared.app_FontPincColor
