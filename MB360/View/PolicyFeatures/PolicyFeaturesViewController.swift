         ...
         */
        {
            ...
            if(employeeDetailsArray.count>0)
            {
                ...
                if (employeeDetailsArray.count>0)
                {
                    ...
                    // let urlreq = NSURL(string: "http://core.mybenefits360.com/appservice/policyfeaturesservice.svc/getpolicyfeatures/1221/673/GMC")
                    let request : NSMutableURLRequest = NSMutableURLRequest()
                    request.url = urlreq as URL?// NSURL(string: urlreq)
                    request.httpMethod = "GET"
...
//                }
    ...
    func setupFontUI(){
        ...
        noDataFoundLbl.font = UIFont(name: FontsConstant.shared.bold, size: CGFloat(FontsConstant.shared.h17))
        noDataFoundLbl.textColor = FontsConstant.shared.app_FontBlackColor
        ...
        noInternetHeaderLbl.font = UIFont(name: FontsConstant.shared.regular, size: CGFloat(FontsConstant.shared.contentSize25))
        noInternetHeaderLbl.textColor = FontsConstant.shared.app_mediumGrayColor
        
        noInternetDescLbl.font = UIFont(name: FontsConstant.shared.regular, size: CGFloat(FontsConstant.shared.h17))
        noInternetDescLbl.textColor = FontsConstant.shared.app_FontBlackColor
