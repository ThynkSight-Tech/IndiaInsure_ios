...
class DentalClinicVC: UIViewController,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,CityNameSelectedProtocol {
...
//        self.searchBar.layer.shadowColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.20).cgColor
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = UIStoryboard.init(name: "Dental", bundle: nil).instantiateViewController(withIdentifier: "SelectDateForDentalVC") as! SelectDateForDentalVC
...
extension DentalClinicVC {
    func setTitle1(_ title: String, andImage image: UIImage) {
        ...
        print("In \(navigationItem.title) DentalClinicVC")
...
extension DentalClinicVC: SkeletonTableViewDataSource {
