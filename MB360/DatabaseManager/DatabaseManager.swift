...
//    }
    ...
    func saveGroupChildMasterDetails(groupDetailsDict: NSDictionary)
    {
        ...
        //let GROUPCHILDSRNO = (groupDetailsDict.value(forKey: "GROUPCHILDSRNO")as! NSString).integerValue
        let GROUPCHILDSRNO = (((groupDetailsDict.value(forKey: "GROUPCHILDSRNO".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        GROUPCHILDSRNOValue = GROUPCHILDSRNO
        let GROUPCODE = (groupDetailsDict.value(forKey:"GROUPCODE") as? String)?.removeSpecialChars
        let GROUPNAME = (groupDetailsDict.value(forKey: "GROUPNAME") as? String)?.removeSpecialChars
...
//        let context = NSPersistentContainer.viewContext
        let employee1 = EMPLOYEE_INFORMATION(context: managedContext)
        print("saveGroupBasicInfoDetails",groupDetailsDict)
        let TPACODE = ((groupDetailsDict.value(forKey: "tpa_code") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let TPANAME = groupDetailsDict.value(forKey:"tpa_name")
        let TPANAME = (groupDetailsDict.value(forKey: "tpa_name") as? String)?.removeSpecialChars
       // let INSCODE = groupDetailsDict.value(forKey: "ins_co_code")as? String
        let INSCODE = ((groupDetailsDict.value(forKey: "ins_co_code") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let INSNAME = groupDetailsDict.value(forKey: "ins_co_name")
        let INSNAME = (groupDetailsDict.value(forKey: "ins_co_name") as? String)?.removeSpecialChars
       // let active = groupDetailsDict.value(forKey: "active")
        let active = ((groupDetailsDict.value(forKey: "active") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let POLICYNO = groupDetailsDict.value(forKey: "policy_number")as? String
        let POLICYNO = ((groupDetailsDict.value(forKey: "policy_number") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let POLICYCOMMDT = groupDetailsDict.value(forKey: "policy_commencement_date")
        let POLICYCOMMDT = ((groupDetailsDict.value(forKey: "policy_commencement_date") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let POLICYVALIDUPTO = groupDetailsDict.value(forKey: "policy_validupto_date")
        let POLICYVALIDUPTO = ((groupDetailsDict.value(forKey: "policy_validupto_date") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let isActive = groupDetailsDict.value(forKey: "active")
        let isActive = ((groupDetailsDict.value(forKey: "active") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let OE_GRP_BAS_INF_SR_NO = employee1.oe_group_base_Info_Sr_No
        let OE_GRP_BAS_INF_SR_NO = employee1.oe_group_base_Info_Sr_No
        //let PRODUCTCODE = groupDetailsDict.value(forKey: "ProductCode")
        let PRODUCTCODE = ((groupDetailsDict.value(forKey: "ProductCode") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let broker = groupDetailsDict.value(forKey: "BROKER_NAME")
        let broker = (groupDetailsDict.value(forKey: "BROKER_NAME") as? String)?.removeSpecialChars
...
//        employee.groupChildSrNo=GROUPCHILDSRNO as? String
        ...
        employee.ins_Code=INSCODE
        employee.ins_Name=INSNAME
        employee.policyComencmentDate=POLICYCOMMDT
        employee.policyNumber=POLICYNO
        employee.policyValidUpto=POLICYVALIDUPTO
        employee.productCode=PRODUCTCODE
        employee.tpa_Code=TPACODE
        employee.tpa_Name=TPANAME
        employee.oE_GRP_BAS_INF_SR_NO = Int32(OE_GRP_BAS_INF_SR_NO)
        employee.isActive=isActive
        employee.brokerName=broker
...
//    }
    func saveEmployeeDetails(enrollmentDetailsDict: NSDictionary,productCode:String)
    {
        ...
        //let GROUPCHILDSRNO = (enrollmentDetailsDict.value(forKey: "groupchildsrno")as! String).replacingOccurrences(of: " ", with: "") as! Int//.integerValue
        let GROUPCHILDSRNO = (((enrollmentDetailsDict.value(forKey: "groupchildsrno")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        print("saveEmployeeDetails",enrollmentDetailsDict)
        //let OE_GRP_BAS_INF_SR_NO = (enrollmentDetailsDict.value(forKey:"oe_grp_bas_inf_sr_no")as! NSString).integerValue
        let OE_GRP_BAS_INF_SR_NO = (((enrollmentDetailsDict.value(forKey: "oe_grp_bas_inf_sr_no")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        
        //let date_of_joining = enrollmentDetailsDict.value(forKey: "date_of_joining")
        let date_of_joining = (enrollmentDetailsDict.value(forKey: "date_of_joining") as! String).replacingOccurrences(of: " ", with: "")
       // let official_e_mail_id = enrollmentDetailsDict.value(forKey: "official_e_mail_id")
        let official_e_mail_id = (enrollmentDetailsDict.value(forKey: "official_e_mail_id") as! String).replacingOccurrences(of: " ", with: "")
        //let department = enrollmentDetailsDict.value(forKey: "department")
        let department = ((enrollmentDetailsDict.value(forKey: "department") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
       // let grade = enrollmentDetailsDict.value(forKey: "grade")
        let grade = ((enrollmentDetailsDict.value(forKey: "grade") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let EMPLOYEEID = enrollmentDetailsDict.value(forKey: "employee_id")
        let EMPLOYEEID = ((enrollmentDetailsDict.value(forKey: "employee_id") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
       // let designation = enrollmentDetailsDict.value(forKey: "designation")
        let designation = ((enrollmentDetailsDict.value(forKey: "designation") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let EMPLOYEESRNO = (enrollmentDetailsDict.value(forKey: "employee_sr_no")as! NSString).integerValue
        let EMPLOYEESRNO = (((enrollmentDetailsDict.value(forKey: "employee_sr_no")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        
        //let base_suminsured = enrollmentDetailsDict.value(forKey: "base_suminsured")
        let base_suminsured = ((enrollmentDetailsDict.value(forKey: "base_suminsured") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let topup_suminsured = enrollmentDetailsDict.value(forKey: "topup_suminsured")
        let topup_suminsured = ((enrollmentDetailsDict.value(forKey: "topup_suminsured") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let date_of_datainsert = enrollmentDetailsDict.value(forKey: "date_of_datainsert")
        let date_of_datainsert = ((enrollmentDetailsDict.value(forKey: "date_of_datainsert") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let topup_si_opted_flag = enrollmentDetailsDict.value(forKey: "topup_si_opted_flag")
        let topup_si_opted_flag = ((enrollmentDetailsDict.value(forKey: "topup_si_opted_flag") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let topup_si_opted = enrollmentDetailsDict.value(forKey: "topup_si_opted")
        let topup_si_opted = ((enrollmentDetailsDict.value(forKey: "topup_si_opted") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
       // let topup_si_pk = enrollmentDetailsDict.value(forKey: "topup_si_pk")
        let topup_si_pk = ((enrollmentDetailsDict.value(forKey: "topup_si_pk") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let topup_si_premium = enrollmentDetailsDict.value(forKey: "topup_si_premium")
        let topup_si_premium = ((enrollmentDetailsDict.value(forKey: "topup_si_premium") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
...
//    }
    ...
    func savePersonDetails(personDetailsDict: NSDictionary)
    {
        ...
        //let person_sr_no = (personDetailsDict.value(forKey: "person_sr_no")as! NSString).integerValue
        let person_sr_no = (((personDetailsDict.value(forKey: "person_sr_no")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        print("savePersonDetails",personDetailsDict)
        //let employee_sr_no = (personDetailsDict.value(forKey:"employee_sr_no")as! NSString).integerValue
        let employee_sr_no = (((personDetailsDict.value(forKey: "employee_sr_no")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        let age = (personDetailsDict.value(forKey: "age")as! NSString).integerValue
        let date_of_birth = personDetailsDict.value(forKey: "date_of_birth")
        let cellphone_no = personDetailsDict.value(forKey: "cellphone_no")
        let emrgcellphone_no = personDetailsDict.value(forKey: "emrgcellphone_no")// Added by Geeta
...
//    }
    ...
    func saveIntimationDetails(intimationDict: NSDictionary)
    {
        ...
        //Portal
        let INT_CLM_INTIMATION_NO = (intimationDict.value(forKey: "INTIMATION_SR_NO") as? String)?.removeSpecialChars
        let CLM_INT_CLAIMANT = (intimationDict.value(forKey: "PERSON_NAME") as! String).removeSpecialChars
        //let INT_CLM_INTIMATION_DT = intimationDict.value(forKey:"INTIMATIONS")
        let INT_CLM_INTIMATION_DT = ((intimationDict.value(forKey:"INTIMATIONS")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let EMPLOYEE_NAME = intimationDict.value(forKey: "EMPLOYEE_NAME")//New
        let EMPLOYEE_NAME = (intimationDict.value(forKey:"EMPLOYEE_NAME")as! String).removeSpecialChars
        //let EMPLOYEE_NO = intimationDict.value(forKey: "EMPLOYEE_NO")//New
        let EMPLOYEE_NO = ((intimationDict.value(forKey:"EMPLOYEE_NO")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let INT_CLM_HOSPITAL = intimationDict.value(forKey: "NAME_OF_HOSPITAL")
        let INT_CLM_HOSPITAL = ((intimationDict.value(forKey:"NAME_OF_HOSPITAL")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let INT_CLM_DOA_LIKELYDOA = intimationDict.value(forKey: "DOA_LIKELYDOA")
        let INT_CLM_DOA_LIKELYDOA = ((intimationDict.value(forKey:"DOA_LIKELYDOA")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let INT_CLM_DIAGNOSIS_OR_AILMENT = intimationDict.value(forKey: "DIAGNOSIS_OR_AILMENT")as? String
        let INT_CLM_DIAGNOSIS_OR_AILMENT = (intimationDict.value(forKey:"DIAGNOSIS_OR_AILMENT")as! String).removeSpecialChars
        //let INT_CLM_CLAIM_AMOUNT = intimationDict.value(forKey:"CLAIM_AMOUNT")
        let INT_CLM_CLAIM_AMOUNT = ((intimationDict.value(forKey:"CLAIM_AMOUNT")as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
    ...
    func saveFaqDetails(contactDict: NSDictionary,productCode : String){
        ...
        var Faq_Question = (contactDict.value(forKey: "Faq_Question") as? String)?.removeSpecialChars
        var Faq_Sr_No = (contactDict.value(forKey: "Faq_Sr_No") as? String)?.removeSpecialChars
        var Faq_Order = (contactDict.value(forKey: "Faq_Order") as? String)?.removeSpecialChars
        var Faq_Ans = (contactDict.value(forKey: "Faq_Ans") as? String)?.removeSpecialChars
    ...
    func saveCoveragesDetails(contactDict: NSDictionary,productCode : String){
        ...
        var TOP_UP_BASE_SUM_INSURED = (contactDict.value(forKey: "TOP_UP_BASE_SUM_INSURED") as? String)?.removeSpecialChars
...
//    }
    ...
    func saveContactDetails(contactDict: NSDictionary,productCode:String)
    {
        ...
        */
        ...
        var ESCALATION = (contactDict.value(forKey: "ESCALATION") as? String)?.removeSpecialChars
//        let PERSON_NAME = contactDict.value(forKey:"CONTACT_PERSON")
//        let ADDRESS = contactDict.value(forKey: "ADDRESS")
//        let LANDLINE_NO = contactDict.value(forKey: "LANDLINE_NO")
//        let MOBILE_NO = contactDict.value(forKey:"MOBILE_NO")
...
//        let CONTACT_TYPE = contactDict.value(forKey:"DESCRIPTION")
        ...
        let PERSON_NAME = (contactDict.value(forKey: "CONTACT_PERSON") as? String)?.removeSpecialChars
        let ADDRESS = (contactDict.value(forKey: "ADDRESS") as? String)?.removeSpecialChars
        let LANDLINE_NO = ((contactDict.value(forKey: "LANDLINE_NO") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        let MOBILE_NO = ((contactDict.value(forKey: "MOBILE_NO") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        let FAX_NO = ((contactDict.value(forKey: "FAX_NO") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        let EMAIL_ID = contactDict.value(forKey: "EMAIL") as? String
        let CONTACT_TYPE = (contactDict.value(forKey: "DESCRIPTION") as? String)?.removeSpecialChars
    ...
    {
        let managedContext = appDelegate.managedObjectContext
        var intimationDetailsArray:Array<ContactDetails>=[];
        ...
        do
        {
           // let sortDescriptor = NSSortDescriptor(key: "escalation", ascending: true)
...
//    }
    ...
    func saveNewPolicyFeatures(contactDict: NSDictionary,productCode:String)
    {
        ...
        let contacts = NSEntityDescription.insertNewObject(forEntityName: policyFeaturesDetailsTable, into: managedContext) as! PolicyFeaturesDetails
        print(contactDict)
        let POL_FEAT_DISPLAY_TYPE = ((contactDict.value(forKey: "POL_FEAT_DISPLAY_TYPE") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        print(POL_FEAT_DISPLAY_TYPE)
//        let POL_FEAT_TYPE = contactDict.value(forKey:"POL_FEAT_TYPE")
        let POL_FEAT_TYPE = ((contactDict.value(forKey: "POL_FEAT_TYPE") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
//        let POL_INFORMATION = contactDict.value(forKey: "POL_INFORMATION")
        let POL_INFORMATION = ((contactDict.value(forKey: "POL_INFORMATION") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
//        let POL_TERMS_CONDITIONS = contactDict.value(forKey: "POL_TERMS_CONDITIONS")
        let POL_TERMS_CONDITIONS = ((contactDict.value(forKey: "POL_TERMS_CONDITIONS") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
//        let POL_INFO_DISPLAY_TO = contactDict.value(forKey: "POL_INFO_DISPLAY_TO")
        let POL_INFO_DISPLAY_TO = ((contactDict.value(forKey: "POL_INFO_DISPLAY_TO") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
...
//    }
    ...
    func saveMyClaimDetails(contactDict: NSDictionary)
    {
        ...
        //let BENEFICIARY = contactDict.value(forKey: "BeneficiaryName")
        let BENEFICIARY = (contactDict.value(forKey: "BeneficiaryName") as! String).removeSpecialChars
        let TYPE_OF_CLAIM = ((contactDict.value(forKey:"ClaimType") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
       // let TOTAL_CLAIM_AMT = contactDict.value(forKey: "ClaimAmount")
        let TOTAL_CLAIM_AMT = ((contactDict.value(forKey:"ClaimAmount") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let CLAIM_DATE = contactDict.value(forKey: "ClaimDate")
        let CLAIM_DATE = ((contactDict.value(forKey:"ClaimDate") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let RELATION = contactDict.value(forKey: "RelationWithEmployee")
        let RELATION = ((contactDict.value(forKey:"RelationWithEmployee") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let CLAIM_Number = contactDict.value(forKey: "ClaimNo")
        let CLAIM_Number = (contactDict.value(forKey:"ClaimNo") as! String).replacingOccurrences(of: " ", with: "") as! String
        //let status = contactDict.value(forKey: "ClaimStatus")
        let status = ((contactDict.value(forKey:"ClaimStatus") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let claimSrNo = contactDict.value(forKey: "ClaimSrNo")
        let claimSrNo = ((contactDict.value(forKey:"ClaimSrNo") as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
...
//    }
    ...
    func saveEmployeeQueries(queryDict: NSDictionary)
    {
        ...
        let contacts = NSEntityDescription.insertNewObject(forEntityName: queriesTable, into: managedContext) as! Queries
        print("Database error log",queryDict)
        //let EQ_CUST_QRY_SR_NO = queryDict.value(forKey: "EQ_CUST_QRY_SR_NO")
        let EQ_CUST_QRY_SR_NO = ((queryDict.value(forKey: "EQ_CUST_QRY_SR_NO") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let TICKET_NUMBER = queryDict.value(forKey:"TICKET_NUMBER")
        let TICKET_NUMBER = ((queryDict.value(forKey: "TICKET_NUMBER") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let COMPLETE_QUERY_TEXT = queryDict.value(forKey: "PARTIAL_QUERY_TEXT")
        let COMPLETE_QUERY_TEXT = (queryDict.value(forKey: "PARTIAL_QUERY_TEXT") as! String).removeSpecialChars
        let POSTED_DATE = queryDict.value(forKey: "POSTED_DATE")
        //let POSTED_DATE = ((queryDict.value(forKey: "POSTED_DATE") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let PERSON_NAME = queryDict.value(forKey: "PERSON_NAME")
        let PERSON_NAME = (queryDict.value(forKey: "PERSON_NAME") as! String).removeSpecialChars
        //let EMPLOYEE_SR_NO = queryDict.value(forKey: "EMPLOYEE_SR_NO")
        let EMPLOYEE_SR_NO = ((queryDict.value(forKey: "EMPLOYEE_SR_NO") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let EQ_CUST_QRY_SOLVED = queryDict.value(forKey: "EQ_CUST_QRY_SOLVED")
        let EQ_CUST_QRY_SOLVED = ((queryDict.value(forKey: "EQ_CUST_QRY_SOLVED") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
       // let NO_OF_REPLIES = queryDict.value(forKey:"NO_OF_REPLIES")
        let NO_OF_REPLIES = ((queryDict.value(forKey: "NO_OF_REPLIES") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
        //let EQ_CUST_QRY_ENDED = queryDict.value(forKey: "EQ_CUST_QRY_ENDED")
        let EQ_CUST_QRY_ENDED = ((queryDict.value(forKey: "EQ_CUST_QRY_ENDED") as? String)?.replacingOccurrences(of: " ", with: "") as? String)?.removeSpecialChars
       // let LAST_REPLY = queryDict.value(forKey: "LAST_REPLY")
        let LAST_REPLY = (queryDict.value(forKey: "LAST_REPLY") as! String).removeSpecialChars
        ...
        contacts.postedDate=POSTED_DATE as? String
        contacts.ticketNumber=TICKET_NUMBER
...
//    }
    ...
    func saveEmployeeDetailsJSON(enrollmentDetailsDict: NSDictionary,productCode:String)
    {
       ...
       // let topup_si_premium = enrollmentDetailsDict.value(forKey: "TOPUP_SI_PREMIUM".uppercased())//...
        ...
        employee.dtaeOfJoining=date_of_joining
        employee.dateofDataInsert=date_of_datainsert //Geeta
        employee.officialEmailID=official_e_mail_id
        employee.empIDNo=EMPLOYEEID
        employee.empSrNo=Int64(EMPLOYEESRNO)
        employee.groupChildSrNo=Int64(GROUPCHILDSRNO)
        ...
        employee.oe_group_base_Info_Sr_No=Int64(OE_GRP_BAS_INF_SR_NO)
        employee.baseSumInsured = base_suminsured
        employee.topupSumInsured = topup_suminsured
        employee.topupoptedflag = topup_si_opted_flag
        employee.topupoptedAmount = topup_si_opted
        employee.topupSrNo = topup_si_pk
        employee.topupSIPremium = topup_si_premium
...
//    }
    ...
    func savePersonDetailsJSON(personDetailsDict: NSDictionary)
    {
        ...
        //let person_sr_no = (personDetailsDict.value(forKey: "PERSON_SR_NO".uppercased())as! NSString).integerValue
        var person_sr_no = (((personDetailsDict.value(forKey: "PERSON_SR_NO".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        //let employee_sr_no = (personDetailsDict.value(forKey:"EMPLOYEE_SR_NO".uppercased())as! NSString).integerValue
        var employee_sr_no = (((personDetailsDict.value(forKey: "EMPLOYEE_SR_NO".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        //let age =
        //let age = (personDetailsDict.value(forKey: "AGE".uppercased())as! NSString).integerValue
        var age = (((personDetailsDict.value(forKey: "AGE".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
        //let date_of_birth = personDetailsDict.value(forKey: "DATE_OF_BIRTH".uppercased())
        var date_of_birth = ((personDetailsDict.value(forKey: "DATE_OF_BIRTH".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let cellphone_no = personDetailsDict.value(forKey: "CELLPHONE_NUMBER".uppercased())
        var cellphone_no = ((personDetailsDict.value(forKey: "CELLPHONE_NUMBER".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
       // let emrgcellphone_no = personDetailsDict.value(forKey: "EMERGENCY_CONTACT_NUMBER".uppercased())
        var emrgcellphone_no = ((personDetailsDict.value(forKey: "EMERGENCY_CONTACT_NUMBER".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
       // let person_name = personDetailsDict.value(forKey: "PERSON_NAME".uppercased())
        var person_name = (personDetailsDict.value(forKey: "PERSON_NAME".uppercased())as! String).removeSpecialChars
        //let gender : String = personDetailsDict.value(forKey: "GENDER".uppercased()) as! String
        var gender = ((personDetailsDict.value(forKey: "GENDER".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //var relationname :String = personDetailsDict.value(forKey: "RELATION_NAME".uppercased())as? String ?? ""
        var relationname = ((personDetailsDict.value(forKey: "RELATION_NAME".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
        //let relationid = (personDetailsDict.value(forKey: "RELATIONID".uppercased())as! NSString).integerValue
        var relationid = (((personDetailsDict.value(forKey: "RELATIONID".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
...
//        }
    ...
    //        let context = NSPersistentContainer.viewContext
       ...
       //        employee. = BROKERNAME as? String
           ...
           print("saveGroupBasicInfoDetailsJSON",groupDetailsDict)
            //let OE_GRP_BAS_INF_SR_NO = (groupDetailsDict.value(forKey: "OE_GRP_BAS_INF_SR_NO")as! NSString).integerValue
            let OE_GRP_BAS_INF_SR_NO = (((groupDetailsDict.value(forKey: "OE_GRP_BAS_INF_SR_NO".uppercased())as! String).replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars as! NSString).integerValue
            
           // let POLICYNO = groupDetailsDict.value(forKey: "POLICY_NUMBER".uppercased())as? String
            let POLICYNO = ((groupDetailsDict.value(forKey: "POLICY_NUMBER".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
            //let INSNAME = groupDetailsDict.value(forKey: "INS_CO_NAME".uppercased())
            let INSNAME = (groupDetailsDict.value(forKey: "INS_CO_NAME".uppercased())as! String).removeSpecialChars
            //let INSCODE = groupDetailsDict.value(forKey: "INS_CODE".uppercased())as? String
            let INSCODE = ((groupDetailsDict.value(forKey: "INS_CODE".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
            //let TPANAME = groupDetailsDict.value(forKey:"TPA_NAME".uppercased())
            let TPANAME = (groupDetailsDict.value(forKey: "TPA_NAME".uppercased())as! String).removeSpecialChars
           // let TPACODE = groupDetailsDict.value(forKey: "TPA_CODE".uppercased())
            let TPACODE = ((groupDetailsDict.value(forKey: "TPA_CODE".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
            //let POLICYCOMMDT = groupDetailsDict.value(forKey: "POLICY_COMMENCEMENT_DATE".uppercased())
            let POLICYCOMMDT = ((groupDetailsDict.value(forKey: "POLICY_COMMENCEMENT_DATE".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
           // let POLICYVALIDUPTO = groupDetailsDict.value(forKey: "POLICY_VALID_UPTO".uppercased())
            let POLICYVALIDUPTO = ((groupDetailsDict.value(forKey: "POLICY_VALID_UPTO".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
            //let isActive = groupDetailsDict.value(forKey: "ACTIVE".uppercased()) as? String
            let isActive = ((groupDetailsDict.value(forKey: "ACTIVE".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
            //let PRODUCTCODE = groupDetailsDict.value(forKey: "PRODUCT_CODE".uppercased())
            let PRODUCTCODE = ((groupDetailsDict.value(forKey: "PRODUCT_CODE".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
            //let TYPE_OF_POL_SR_NO = groupDetailsDict.value(forKey: "TYPE_OF_POL_SR_NO".uppercased())
            let TYPE_OF_POL_SR_NO = ((groupDetailsDict.value(forKey: "TYPE_OF_POL_SR_NO".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
          //  let POLICY_TYPE = groupDetailsDict.value(forKey: "POLICY_TYPE".uppercased())
            let POLICY_TYPE = ((groupDetailsDict.value(forKey: "POLICY_TYPE".uppercased())as? String)?.replacingOccurrences(of: " ", with: "") as! String).removeSpecialChars
    ...
    //        employee. = BROKERNAME as? String
            ...
            employee.isActive=isActive
            employee.productCode=PRODUCTCODE
            employee.typeOfPolSrNo=TYPE_OF_POL_SR_NO
            employee.policyType=POLICY_TYPE
    ...
    func saveEnrollmentGroupRelatoionsDetailsJSON(contactDict: NSDictionary)
       {
           ...
           let MaxAge = contactDict.value(forKey: "MAX_AGE")
