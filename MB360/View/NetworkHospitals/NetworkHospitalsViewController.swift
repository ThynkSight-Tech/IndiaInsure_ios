...
//        m_tableview.tableFooterView = spinner
                            ...
                            DispatchQueue.main.async
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        self.m_emptyStateImageView.image=UIImage(named: "Nohospital"); self.m_emptyStateTitleLbl.text="oops!".localized()
                                        self.m_emptyStateDetailsLbl.text="hospitalNotFoundErrorMsg".localized()
    ...
    func setFontUI(){
        if #available(iOS 13.0, *) {
            m_searchBar.searchTextField.font = UIFont(name: FontsConstant.shared.OpenSansRegular, size: CGFloat(FontsConstant.shared.h17))
        } else {
            // Fallback on earlier versions
        }
        ...
        m_emptyStateDetailsLbl.font = UIFont(name: FontsConstant.shared.OpenSansRegular, size: CGFloat(FontsConstant.shared.h15))
        m_emptyStateDetailsLbl.textColor = FontsConstant.shared.app_FontSecondryColor
       
        m_emptyStateTitleLbl.font = UIFont(name: FontsConstant.shared.OpenSansRegular, size: CGFloat(FontsConstant.shared.h15))
        m_emptyStateTitleLbl.textColor = FontsConstant.shared.app_FontSecondryColor
    ...
    override func viewDidAppear(_ animated: Bool)
    {
        ...
        {
            self.serachNearbyButtonTopConstraint.constant=110
            m_searchBar.isHidden=true
            m_orLbl.isHidden=true
            m_tableVIewConstraintWithSuperview.constant=0
        }
    ...
    override func rightButtonClicked()
    {
        ...
        //        if(m_tableview.isHidden && m_searchTableview.isHidden)
        //        {
        ////            serachNearbyButtonTopConstraint.constant=80
        //        }
        //        else
        //        {
        //            serachNearbyButtonTopConstraint.constant=150
        //        }
        //
        
        
        
        /* self.m_searchBar = UISearchController(searchResultsController:  nil)
         
         self.m_searchBar.searchResultsUpdater = self
         self.m_searchBar.delegate = self
         self.m_searchBar.searchBar.delegate = self
         
         self.m_searchBar.hidesNavigationBarDuringPresentation = false
         self.m_searchBar.dimsBackgroundDuringPresentation = false
         
         self.navigationItem.titleView = m_searchBar.searchBar
         m_searchBar.searchBar.isTranslucent=false
...
//
//       /* cell.m_primaryCountButton.backgroundColor = FontsConstant.shared.app_ButtonBGColor
//        cell.m_secondaryCountButton.backgroundColor = UIColor.clear
//        cell.m_tertiaryCountButton.backgroundColor = UIColor.clear
//        cell.m_OtherCountButton.backgroundColor = UIColor.clear
//        */
...
//            let level = dict.value(forKey: "HospitalLevelOfCare") as? String
//            if(level=="Primary")
//            {
...
//
//        }
//        //        sender.backgroundColor=hexStringToUIColor(hex: "E3EAFD")
//
...
//        m_tableview.reloadData()
        ...
        if resultsDictArray.isEmpty{
            ...
            self.m_emptyStateTitleLbl.text="oops!".localized()
            self.m_emptyStateDetailsLbl.text = "No primary hospitals found!"
            self.TopHeaderBackgroundView.isHidden=true
            self.m_nearbyHospitalsButton.isHidden=true
            self.m_tableview.isHidden=false
...
//        let cell = m_tableview.cellForRow(at: indexpath) as! NetworkHospitalsTableViewCell
//        /*
//        cell.m_primaryCountButton.backgroundColor = UIColor.clear
//        cell.m_secondaryCountButton.backgroundColor = FontsConstant.shared.app_ButtonBGColor
//        cell.m_tertiaryCountButton.backgroundColor = UIColor.clear
//        cell.m_OtherCountButton.backgroundColor = UIColor.clear
//       */
//
...
//        m_tableview.reloadData()
        ...
        if resultsDictArray.isEmpty{
            ...
            self.m_emptyStateImageView.image=UIImage(named: "Nohospital");
            self.m_emptyStateTitleLbl.text="oops!".localized()
            self.m_emptyStateDetailsLbl.text = "No secondary hospitals found!"
            self.TopHeaderBackgroundView.isHidden=true
            self.m_nearbyHospitalsButton.isHidden=true
            self.m_tableview.isHidden=false
    ...
    @objc func tertiaryCountButtonClicked(sender:UIButton)
    {
        ...
        cell.m_primaryCountButton.backgroundColor = UIColor.clear
        cell.m_secondaryCountButton.backgroundColor = UIColor.clear
        cell.m_tertiaryCountButton.backgroundColor = FontsConstant.shared.app_ButtonBGColor
        cell.m_OtherCountButton.backgroundColor = UIColor.clear
       */
        ...
        if resultsDictArray.isEmpty{
            ...
            self.m_emptyStateImageView.image=UIImage(named: "Nohospital");
            self.m_emptyStateTitleLbl.text="oops!".localized()
            self.m_emptyStateDetailsLbl.text = "No tertiary hospitals found!"
            self.TopHeaderBackgroundView.isHidden=true
            self.m_nearbyHospitalsButton.isHidden=true
            self.m_tableview.isHidden=false
    ...
    @objc func otherCountButtonClicked(sender:UIButton)
    {
        ...
        cell.m_secondaryCountButton.backgroundColor = UIColor.clear
        cell.m_tertiaryCountButton.backgroundColor = UIColor.clear
        cell.m_OtherCountButton.backgroundColor = FontsConstant.shared.app_ButtonBGColor
       */
        ...
        if resultsDictArray.isEmpty{
            ...
            self.m_emptyStateImageView.image=UIImage(named: "Nohospital");
            self.m_emptyStateTitleLbl.text="oops!".localized()
            self.m_emptyStateDetailsLbl.text = "No other hospitals found!"
            self.TopHeaderBackgroundView.isHidden=true
            self.m_nearbyHospitalsButton.isHidden=true
            self.m_tableview.isHidden=false
                ...
                if let groupChlNo = m_employeedict?.groupChildSrNo{
                    groupChildSrNo=String(groupChlNo)
                        ...
                        if isFirstTime{
                           ...
                           //  string = "<DataRequest><groupchildsrno>\(groupChildSrNo)</groupchildsrno><oegrpbasinfsrno>\(oegrpbasinfsrno)</oegrpbasinfsrno><hospitalsearchtext>411016</hospitalsearchtext></DataRequest>"
                        }
...
//                DatabaseManager.sharedInstance.saveNetworkHospitalsDetails(contactDict: DictVal)
    ...
    func getCount()
    {
        ...
        for dict in resultsDictArray
        {
            ...
            let level = hospitalDict.value(forKey: "HospitalLevelOfCare") as? String
            ...
            else
            {
                ...
                if isNearBy{
                    ...
                    if m_nearbyHospitalsArrayNew.count > indexPath.row - 1 {
                        ...
                        cell.m_nameLbl.text=m_resultDict.value(forKey: "HospitalName") as? String
                        var address = m_resultDict.value(forKey: "HospitalAddress") as? String
                        ...
                        var contactNumber = m_resultDict.value(forKey: "HospitalContactNo") as? String
                        ...
                        case "Primary"?:
                            ...
                            cell.m_levelLbl.textColor=hexStringToUIColor(hex: hightlightColor)
                            cell.m_colorCodeLbl.backgroundColor=hexStringToUIColor(hex: hightlightColor)
                            ...
                            cell.badgeImageView.image = #imageLiteral(resourceName: "Badge_E2046E")
                        ...
                        case "Secondary"?:
                            ...
                            cell.m_colorCodeLbl.isHidden=false
                            //cell.m_levelLbl.textColor=hexStringToUIColor(hex: "e7be2a")
                            //cell.m_colorCodeLbl.backgroundColor=hexStringToUIColor(hex: "e7be2a")
                            cell.m_levelLbl.textColor=Color.pinc_LabelPrimaryColor.value
                            cell.m_colorCodeLbl.backgroundColor=Color.pinc_LabelPrimaryColor.value
                            cell.m_topConstraint.constant=45
                            cell.m_levelLbl.isHidden=false
                            cell.m_levelLbl.text=level!+" "+"careLbl".localized()
                            ...
                            cell.badgeImageView.image=#imageLiteral(resourceName: "Badge_456E72")
                            break
                        case "Tertiary"?:
                            
                            cell.m_colorCodeLbl.isHidden=false
                            //cell.m_levelLbl.textColor=hexStringToUIColor(hex: "ff1000")
                            //cell.m_colorCodeLbl.backgroundColor=hexStringToUIColor(hex: "ff1000")
                            cell.m_levelLbl.textColor=Color.pinc_SecondryColor.value
                            cell.m_colorCodeLbl.backgroundColor=Color.pinc_SecondryColor.value
                            cell.m_topConstraint.constant=45
                            cell.m_levelLbl.isHidden=false
                            cell.m_levelLbl.text=level!+" "+"careLbl".localized()
                            ...
                            cell.badgeImageView.image=#imageLiteral(resourceName: "Badge_622140")
                        ...
                        case "NOT AVAILABLE"?:
                            ...
                            //cell.m_levelLbl.textColor=hexStringToUIColor(hex: "ff1000")
                            //cell.m_colorCodeLbl.backgroundColor=hexStringToUIColor(hex: "ff1000")
                            cell.m_levelLbl.textColor=Color.pinc_LabelSecondryColor.value
                            cell.m_colorCodeLbl.backgroundColor=Color.pinc_LabelSecondryColor.value
                            cell.m_topConstraint.constant=45
                            cell.m_levelLbl.isHidden=false
                            cell.m_levelLbl.text=level!+" "+"careLbl".localized()
                            ...
                            //            tertiaryResultsDictArray?.append(m_resultDict as! [String : String])
                            //cell.badgeImageView.image=#imageLiteral(resourceName: "Badge_Red")
                            cell.badgeImageView.image=#imageLiteral(resourceName: "Badge_5B5B5B")
...
//                    }
    ...
    func searchBarTextDidEndEditing(_ searchBar: UISearchBar)
    {
        ...
        {
            isfromSearchString = true
            if(searchString.count>0 && searchString != " ")
            {
                isSearchNearby = true
                isNearBy = false
            ...
            //            m_nearbyHospitalsButton.isHidden=true
            //            serachNearbyButtonTopConstraint.constant=110
