...
class ProfileViewForWellness: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    self.navigationItem.title = "My Profile"
        print("In \(navigationItem.title ?? "") ProfileViewForWellness")
