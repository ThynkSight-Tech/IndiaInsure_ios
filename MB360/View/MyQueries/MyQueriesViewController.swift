        ...
        dateDropDown.selectionAction =
            {
                ...
                case "E-Cards":
                    ...
                    self.m_answersArray=["Your E-card is available on the Dashboard. In the link availble at the bottom of the page, next to contact."," Yes. If your Employer insists on physical card then the same is couriered to your Corporate Address. Alternatively you can use a print-out of the E-Card.","This happens when either your Enrollment Window is still open or your data is under process at the Insurance Company.","E-cards are visible within 7-10 Working Days on MB360 Portal from receipt of your Enrollment Details through HR or your Window Period Closure. The physical cards are dispatched to your HR, within 10-15 days from the receipt of enrollment details.","Yes. You get individual e-card for all the members who are enrolled in the policy.","Either you have not provided your family members details to your HR for enrollment in the policy OR you have not added them on MB360 Portal during Enrollment Window period.","For any correction in your E-card, you are requested to provide correct details to your Account manager/HR alongwith necessary copy of identity proof (e.g. Copy of Aadhaar Card or Pan Card or Driving License or Election Card or Passport or Marriage Certificate in case of newly married spouse)","Your E-Card is an identification card only, and can be used excusilvely for Cashless claims. Claimant will have to produce a government authorised identity proof along with the E-Card at the Admission Counter / TPA Desk at Network Hospital during cashless claims process. For Reimbursment claims, attach a copy of the E-Card along with the Claim Documents during submission.","No. Your E-Card cannot be used as an Identity proof because it does not carry any photo on it. Hence a Government Authorised photo identity proof should be produced alongwith your E-Card (viz. Aadhaar Card, Pan Card, Driving License, Election Card, Passport Copy etc.)","The validity of your E-Card is till the expiry of policy OR your date of leaving the organisation, whichever is earlier."]
                    break
...
ONLINE ENROLLMENT
Step 1:  Employee's Enrollment Data provided by the HR is uploaded in MB360 Portal.
...
"""
                    ...
                    self.m_answersArray=[enrollmentDetailString,"The Window Period is a duration of time given to the Employee to login to MB360 Portal and add/modify/delete their dependant information, as per policy terms & conditions. This maximum period alloted for this is 15 days but it may vary for each Employer Group. Refer the welcome mail received from MB360 for ou excat Window Period.","The Window Period is a duration of time given to the Employee to login to MB360 Portal and add/modify/delete  their dependant information, as per policy terms & conditions. This maximum period alloted for this is 15 days but it may  vary for each Employer Group. Refer the welcome mail received from MB360 for your exact Window Period. Your  Window Period closes after this stipulated time and you will not be able enroll dependants for Insurance Cover. In such an event contact your HR for futher guidance.","It means your  Window Period has closed and you have not enrolled dependants in the stipulated time. In such an event contact your HR for futher guidance.","Life Events refers to 'Mid-term inclusions of new born baby and spouse on account of marriage.' You are required to update the same on the MB360 portal within 15 days of the event and also intimate the HR about the same."]
                    break
...
In order to avail the cashless claim facility, the insured has to be treated in a Network hospital. List of Network Hospitals can be found of MB360 App under the Network Hosptials link. By providing the details of the health insurance policy and presenting the e-card or other physical proof of the health insurance taken in the name of the policyholder, he or she can avail cashless hospitalization and treatment, if the illness/ injury is covered under the policy.
...
Please refer the Claim Procedures Link on MB360 App for detailed information.
"""
...
"""
                    self.m_answersArray=[cashlessProcessString,"Cashless hospitalizations facility can be availed in any of the Network Hospitals empanelled with your TPA. List of Network Hospitals can be found of MB360 portal under the Network Hosptials link.","The TPA sanctions the initial cashless amount within 4-5 hours of cashless request from the hospital.","In India, hospitals may charge deposits from customers before they are admitted. While in normal circumstances, customers are not required to pay any cash, if they have taken a cashless policy, it has been observed that some hospitals ask such customers to pay a flat deposit. This deposit amount charged by hospitals depends on the type of surgery and the choice of hospitalization made. This deposit is generally taken for expenses not covered in the policy.",processString,"On receipt of the cashless request by the TPA from the Hopital and subsequent processing of the same, the Employee will receive automated SMS and email of the same on their registered mobile number and email id from MB360 at all stages of claim process and settlement. Real time status of the claim is also available on MB360 under the Claim Status link.","Emergency Contact details are mentioned under the link Contact Details in your MB360 login.",deniedString]
                    break
...
Please refer the Claim Procedures Link on MB360 Portal for detailed information.
"""
...
"""
                ...
                case "Dependant Addition/Correction/Deletion":
                    ...
                    let dependantString="""
Step 1: Login to MB360 portal using login credentials mentioned in the Welcome Mail.
...
"""
                ...
                case "Hospital Related":
                    ...
                    self.m_answersArray=["Network Hospitals are Tertiary Care Hospitals / Secondary Care Hospitals / Nursing Homes / Day Care Centres empanelled with the TPA / Insurance Company, who entered into an agreement with the TPA / Insurance Company to provide Cashless facility to policyholders.","Updated list of Netwrok Hospitals can be found in the MB360 Login under the link Network Hospitals","Yes. The list of Network Hospitals is a dynamic list and therefore the latest can be verified and downloaded from MB360 portal","Yes. You can make reimbursement claim in a  Network hospital.","Non-Network Hospitals are those hospitals which have not been empanelled with the TPA / Insurance Company and cannot provide Cashless Treatment."]
                    break
                case "Contact Details":
                    ...
                    self.m_answersArray=["Please refer the Contact Details link in MB360 for your Account Manager details. You can also raise a query ticket in the Employee Queries module. Your query will be resolved within 24 hrs of raising the query.","All queries raised on MB360 are answered. MB360 has a TAT of 24 hrs for query resolution.","If you find the query resolution unsatisfactory, you have an option to continue the query discussion till resolution or raise a new Query ticket."]
                    break
                case "Claim Tracking":
                    let claimStatusString = """
                    Yes - Insured  will receive automated SMS and email of claim on their registered mobile number and email id from MB360 at all stages of claim process and settlement. The stages of claim status are:
                    i.) Claim Intimation
...
"""
                    ...
                    self.m_answersArray=["Real time status of the claim is available of MB360 under the Claim Status link. Insured  will receive automated SMS and email of the same on their registered mobile number and email id from MB360 at all stages of claim process and settlement.",claimStatusString]
                    break
                default:
                    break
                }
...
extension MyQueriesViewController : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        else
        {
            ...
            if let queryNo = m_querisArray[indexPath.row].queryNo
            {
                viewQueryVC.m_queryNo=queryNo
                let dict=m_querisArray[indexPath.row]
                viewQueryVC.m_queryDict=dict
            }
            
            //Added By Pranit 6th Aug 19
            let dict = m_querisArray[indexPath.row]
            if let ticketNo = dict.ticketNumber  {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        if(tableView==m_myQueryTableView)
        {
            ...
            let dict = m_querisArray[indexPath.row]
            cell.m_queryNoLbl.text=dict.ticketNumber
            cell.m_queryDateLbl.text=dict.postedDate
            if let lastReply = dict.lastReply
            {
                
                if(lastReply=="This query has no replies")
                {
                    if dict.querySolvedStatus=="1" || dict.queryEndedStatus=="1" {
                        cell.m_queryDetailTextLbl.text = lastReply
                    }
                    else {
                        cell.m_queryDetailTextLbl.text = dict.completeQueryText
                    }
                }
                else
                {
            ...
            if let replies = dict.noofReplies
            {
