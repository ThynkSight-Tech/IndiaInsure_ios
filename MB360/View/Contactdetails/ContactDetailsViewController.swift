...
class ContactDetailsViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,XMLParserDelegate, NewPoicySelectedDelegate {
    ...
    func setupFontsUI(){
        ...
        m_errorMsgTitleLbl.font = UIFont(name: FontsConstant.shared.OpenSansBold, size: CGFloat(FontsConstant.shared.h17))
        m_errorMsgTitleLbl.textColor = FontsConstant.shared.app_FontSecondryColor
        
        m_errorMsgDetailLbl.font = UIFont(name: FontsConstant.shared.OpenSansRegular, size: CGFloat(FontsConstant.shared.h15))
        m_errorMsgDetailLbl.textColor = FontsConstant.shared.app_FontSecondryColor
...
//                print(try! AesEncryption.decrypt(employeesrno))
//                print(try! AesEncryption.decrypt(groupchildsrno))
//                print(try! AesEncryption.decrypt(oegrpbasinfsrno))
...
//                            self.alertForLogout()
                            ...
                            self.hidePleaseWait()
                            //var str = self.errorMsg(httpresponse.statusCode)
...
//                oegrpbasinfsrno = String(userDict.oe_group_base_Info_Sr_No)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        if(contactDetailsArray.count==0)
        {
            ...
            m_errorMsgTitleLbl.text="No contacts found"
            m_errorMsgDetailLbl.text=""
        }
...
//            let mobNumber = String()
            ...
            let phoneNo = contactDict.phoneNumber
